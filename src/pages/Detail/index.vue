          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="plus" @mousedown="holdDown(1)" @mouseup="holdUp">+</a>
                <a href="javascript:" class="mins" @mousedown="holdDown(-1)" @mouseup="holdUp">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  computed: {
    ...
    skuImageList() {
      // console.log('skuImageList', this.skuInfo.skuImageList);
      return this.skuInfo.skuImageList || []
    }
  },
  methods: {
    changeSkuNum(event) {
      if (event.target.value < 1) this.skuNum = 1
    ...
    holdDown(num) {
      ...
      this.timer = setTimeout(() => {
        this.changeSkuNumFast(num)
      }, 500);
    },
    changeSkuNumFast(num) {
      this.skuNum += num
      if (this.skuNum < 1) this.skuNum = 1
    ...
    async addToCart() {
      try {
        let result = await this.$store.dispatch("addToCart", { skuId: this.$route.params.skuid, skuName: this.skuNum })
