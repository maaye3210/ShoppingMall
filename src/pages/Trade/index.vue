<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div v-for="address in addressInfo" :key="address.id" class="address clearFix">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="good in orderInfo.detailArrayList" :key="good.skuId">
          <li>
            <img :src="good.imgUrl" style="width: 100px;" alt="">
          </li>
          <li>
            <p>
              {{good.skuName}}</p>
    ...
    <div class="sub clearFix">
      <div class="subBtn" to="/pay" @click="submitOrder()">提交订单</div>
    </div>
  </div>
</template>
